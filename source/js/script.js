...
(function () {
  ...
  var closeSuccessModalButton = successModal.querySelector('.js-close-success-modal'
  );
  ...
  var closeCallBackModalButton = callBackModal.querySelector('.js-close-call-back-modal'
  );

  var callBackNameInput = callBackModal.querySelector('.call-back-modal__item--name .call-back-modal__input'
  );
  var callBackPhoneInput = callBackModal.querySelector('.call-back-modal__item--phone .call-back-modal__input'
  );
  var callBackCheckbox = callBackModal.querySelector('.call-back-modal__checkbox-input'
  );
  var callBackModalSubmitButton = callBackModal.querySelector('.js-call-back-modal-submit-button'
  );
  ...
  var openModal = function (modal, visibleClass, onEscFunction, onClickFunction
  ) {
  ...
  submitButton.addEventListener('click', function (evt) {
    if (
      ...
      evt.preventDefault();
      openModal(successModal, 'success-modal--visible', onMessageEscPress, closeModalOnButtonClick
      );
  ...
  callBackButton.addEventListener('click', function () {
    openModal(callBackModal, 'call-back-modal--visible', onMessageEscPressCallBackModal, closeModalOnButtonClickCallBackModal
    );
    resetForm(itemNameInput, itemPhoneInput, checkbox);
  });
  ...
  callBackModalSubmitButton.addEventListener('click', function (evt) {
    if (
      ...
      validateCheckbox(callBackCheckbox, 'call-back-modal__checkbox-input--error'
      )
    ) {
      evt.preventDefault();
      closeCallBackModal();
